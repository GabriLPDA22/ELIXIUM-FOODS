      ...
      <div class="detail-group">
        ...
        <div class="detail-value payment-method-value" v-if="selectedPaymentMethod">
          <div class="payment-method-logo">
            <img v-if="selectedPaymentMethod.cardType === 'visa'" src="https://www.abc.es/recetasderechupete/tortilla-de-patatas-espanola-receta-paso-a-paso/5182/" alt="Visa" class="payment-logo-img">
            <img v-else-if="selectedPaymentMethod.cardType === 'mastercard'" src="https://www.abc.es/recetasderechupete/tortilla-de-patatas-espanola-receta-paso-a-paso/5182/" alt="Mastercard" class="payment-logo-img">
            <img v-else-if="selectedPaymentMethod.cardType === 'amex'" src="https://www.abc.es/recetasderechupete/tortilla-de-patatas-espanola-receta-paso-a-paso/5182/" alt="Amex" class="payment-logo-img">
